...
parser.add_argument(
    "--model",
    default="AE",
    help="Diffusion model to load. Options are: Diffu, AE, all",
)
...
from scripts.utils import GeomConverter, NNConverter, SetFig, make_histogram
import math
...
if flags.sample:
    ...
    )  # DOUG RETURN HERE TO FIX BATCH SIZE FROM CONFIG
    ...
    fout_ex = "{}/{}_{}_norm_voxels.{}".format(
        plot_folder, dataset_config["CHECKPOINT_NAME"], flags.model, plt_exts[0]
    )
    make_histogram(
