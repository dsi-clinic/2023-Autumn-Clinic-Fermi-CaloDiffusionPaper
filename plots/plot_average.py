...
parser = argparse.ArgumentParser(
    description=(
        "Evaluate calorimeter showers of the "
...
parser.add_argument(
    "--input_file",
    "-i",
    help="Name of the input file to be evaluated.",
    choices=[
        "/net/projects/fermi-1/data/dataset_1/dataset_1_pions_1.hdf5",
...
parser.add_argument("--cls_n_iters", type=int, default=1, help="Repeat n times")
parser.add_argument(
    "--cls_n_hidden",
    type=int,
    default="2048",
...
if __name__ == "__main__":
    ...
    hlf.DrawAverageShower(
        ...
        filename=os.path.join(
            args.output_dir,
            "average_shower_{}_pca_n_comp_{}.{}".format(
                args.dataset, components, plt_ext
            ),
        ),
        title=title,
    )
