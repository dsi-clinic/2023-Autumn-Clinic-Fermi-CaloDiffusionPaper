...
#SBATCH --output=/home/emilytong/2023-Autumn-Clinic-Fermi-CaloDiffusionPaper/logs/%j.%N.stdout
#SBATCH --error=/home/emilytong/2023-Autumn-Clinic-Fermi-CaloDiffusionPaper/logs/%j.%N.stderr
#SBATCH --chdir=/home/emilytong/2023-Autumn-Clinic-Fermi-CaloDiffusionPaper/scripts
...
python3 autoencoder/train_ae_class.py \
