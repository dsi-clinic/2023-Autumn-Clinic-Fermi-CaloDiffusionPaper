...
#SBATCH --chdir=/home/aaronz/CaloDiffusionPaper/CaloChallenge/code
...
python3 evaluate.py \
	--input_file /home/aaronz/CaloDiffusionPaper/models/dataset1_phot_Diffu/generated_dataset1_phot_Diffu.h5 \
